...
public:
	...
	virtual void metrics_add_count(const String &p_name, int64_t p_value = 1, const Dictionary &p_attributes = Dictionary()) = 0;
	virtual void metrics_add_gauge(const String &p_name, double p_value, const String &p_unit = String(), const Dictionary &p_attributes = Dictionary()) = 0;
	virtual void metrics_add_distribution(const String &p_name, double p_value, const String &p_unit = String(), const Dictionary &p_attributes = Dictionary()) = 0;
