...
void SentrySDK::_bind_methods() {
	...
	ClassDB::bind_method(D_METHOD("add_breadcrumb", "message", "category", "level", "type", "data"), &SentrySDK::add_breadcrumb, DEFVAL(""), DEFVAL(LEVEL_INFO), DEFVAL("default"), DEFVAL(Dictionary()));
