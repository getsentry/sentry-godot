...
class DisabledSDK : public InternalSDK {
	...
	virtual void count(const String &p_name, int64_t p_value, const Dictionary &p_attributes = Dictionary()) override {}
	virtual void gauge(const String &p_name, double p_value, const String &p_unit = String(), const Dictionary &p_attributes = Dictionary()) override {}
	virtual void distribution(const String &p_name, double p_value, const String &p_unit = String(), const Dictionary &p_attributes = Dictionary()) override {}
