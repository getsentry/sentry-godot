...
void SentryEvent::_bind_methods() {
	...
	BIND_ENUM_CONSTANT(EVENT_TYPE_CUSTOM);
	BIND_ENUM_CONSTANT(EVENT_TYPE_CRASH);
	BIND_ENUM_CONSTANT(EVENT_TYPE_ERROR);

	BIND_BITFIELD_FLAG(EVENT_MASK_NONE);
	BIND_BITFIELD_FLAG(EVENT_MASK_CUSTOM_EVENTS);
	BIND_BITFIELD_FLAG(EVENT_MASK_CRASH_EVENTS);
	BIND_BITFIELD_FLAG(EVENT_MASK_ERROR_EVENTS);
	BIND_BITFIELD_FLAG(EVENT_MASK_ALL_EVENTS);
}
