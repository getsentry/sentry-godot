...
void SentryOptions::_load_project_settings(const Ref<SentryOptions> &p_options) {
	...
	p_options->screenshot_event_types = (int)ProjectSettings::get_singleton()->get_setting("sentry/options/screenshot_event_types", p_options->screenshot_event_types);
...
void SentryOptions::_bind_methods() {
	...
	BIND_PROPERTY(SentryOptions, PropertyInfo(Variant::INT, "screenshot_event_types"), set_screenshot_event_types, get_screenshot_event_types);
