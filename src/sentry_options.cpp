...
void SentryOptions::_define_project_settings(const Ref<SentryOptions> &p_options) {
	...
	_define_setting(PropertyInfo(Variant::INT, "sentry/options/screenshot_event_mask", godot::PROPERTY_HINT_FLAGS, "Custom events,Crash events,Error events"), p_options->screenshot_event_mask);
...
void SentryOptions::_load_project_settings(const Ref<SentryOptions> &p_options) {
	...
	p_options->screenshot_event_mask = (int)ProjectSettings::get_singleton()->get_setting("sentry/options/screenshot_event_mask", p_options->screenshot_event_mask);
...
void SentryOptions::_bind_methods() {
	...
	BIND_PROPERTY(SentryOptions, PropertyInfo(Variant::INT, "screenshot_event_mask"), set_screenshot_event_mask, get_screenshot_event_mask);
